...
export const PRODUCT_PAGES: ProductPages = {
  ...
  'last-night': {
    ...
    physical: [
      'The instrument is the plate. A 100 mm long, 20–60 mm tall, 0.5–6 mm thick sheet of material sits in a resilient-rubber-rail cartridge frame. A surface exciter glued to one face drives the plate into its flexural modes; two piezo pickups on the opposite face read the resonance at different positions (near = bright, far = warm). A small solenoid above the plate, fitted with a felt tip, can be CV-driven against the surface to damp the sustain — physical attack and decay control, not envelope simulation.',
      'Cartridge swap takes about ten seconds. The frame carries the plate, the exciter, both pickups and the solenoid on a single PETG (prototype) or milled-aluminium (production) chassis, connecting to the module via two mini-XLR (audio, shielded) and two JST-XH (exciter + solenoid). Six materials ship in Phase 1: raw oak, linseed oak, shellac maple, marble, brass, spring steel. Phase 2 adds ebony, nephrite, copper, pyrex glass, scapula bone, titanium.',
      'Everything downstream of the plate is analogue. A class-AB push-pull driver feeds the exciter; an LSK489A dual JFET front-ends the piezos; an LM13700 OTA runs the envelope-follower VCA; a zener-noise source can be mixed in as continuous hiss or, in Phase 2, fired as discrete Geiger-counter clicks. Feedback is SPICE-verified stable with LED soft-clipping. No DSP touches the signal at any point.',
    ],
    sigchain: [

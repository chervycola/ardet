...
const TRANSLATIONS: Record<Lang, Dict> = {
  en: {
    ...
    ln_spec_power: 'Power',
    ln_spec_power_v: '±12 V · 800 mA',
    ln_spec_io: 'I/O',
    ln_spec_io_v: 'Mono / stereo in / stereo out · 3.5 mm',
    ln_spec_pickups: 'Pickups',
    ln_spec_pickups_v: '2 × piezo · mini-XLR shielded',
    ln_spec_exciter: 'Exciter',
    ln_spec_exciter_v: 'Dayton DAEX32 · 4 Ω',
  ...
  ru: {
    ...
    ln_spec_power_v: '±12 В · 800 мА',
    ln_spec_io: 'I/O',
    ln_spec_io_v: 'Моно и стерео вход / стерео выход · 3.5 мм',

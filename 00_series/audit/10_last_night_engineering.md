...
Заявлен **star ground** + GND pour на B.Cu. На 2-слойной PCB 190×108мм (40HP × 108мм) это физически **не star**, а скорее "star-like with compromises". 40HP формат даёт более просторный layout, что улучшает возможности star-ground реализации vs предыдущий 20HP. Реальные return paths:

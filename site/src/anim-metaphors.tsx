...
import { nextBladeId } from './motifs';
import type { MetaphorKey } from './types';
    ...
    <svg viewBox="0 0 120 160" className="anim-icon" aria-label="suspend">
      <g className="no-swing">
        ...
        <g transform="translate(60, 32)">
          <path d="M -11 0 Q -14 18 -11 36 L 11 36 Q 14 18 11 0 Z" fill="oklch(0.16 0.04 25)" stroke="var(--accent)" strokeWidth="1.4" />
          <line x1="-2" y1="0" x2="-2" y2="36" stroke="oklch(0.30 0.10 25)" strokeWidth="1" />
          {Array.from({ length: 7 }).map((_unused, i) => {
            const y = 3 + i * 4;
            return <line key={i} x1="-11" y1={y} x2="11" y2={y + 3} stroke="var(--accent)" strokeWidth="1.4" />;
          })}
...
function AnimBottle() {
  return (
    <svg viewBox="0 0 100 220" className="anim-icon" aria-label="fill">
      ...
      <path
        d="M 42 58 Q 20 76 20 96 L 20 200 Q 20 216 36 216 L 64 216 Q 80 216 80 200 L 80 96 Q 80 76 58 58 Z"
        fill="none"
        stroke="var(--accent)"
        strokeWidth="2"
      />
  ...
  return (
    <svg viewBox="0 0 100 220" className="anim-icon" aria-label="drain">
      <g className="hg-frame">
        ...
        <path
          d="M 24 12 L 76 12 L 50 110 L 76 208 L 24 208 L 50 110 Z"
          fill="none"
          stroke="var(--accent)"
          strokeWidth="2.4"
        />
...
export const ANIM_METAPHOR_MAP: Record<MetaphorKey, () => JSX.Element> = {
  razor: AnimRazor,
  shotgun: AnimShotgun,
  capsule: AnimCapsule,
  noose: AnimNoose,
...
export const ANIM_METAPHOR_LABELS: Record<MetaphorKey, string> = {
  razor: 'M·01 / CUT',
...
export const ANIM_METAPHOR_SUB: Record<MetaphorKey, string> = {

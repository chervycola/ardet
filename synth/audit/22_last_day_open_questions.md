...
**Recomend**: **4-layer PCB** с dedicated GND plane для Last Day — обязательно (20HP × 110мм имеет место). Это $20 удорожание, но единственный способ contain noise в такой complex schematic.

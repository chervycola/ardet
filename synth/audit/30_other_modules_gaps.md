...
> ⚠ **HISTORICAL SNAPSHOT (pre-2026-05)** — §7 «AND MY — TBD» ниже отражает состояние до пересмотра архитектуры And My. С 2026-05 модуль re-spec'нут (MOSFET-shaper из ESC FPV-дрона + выносной пилотный пульт, edition of 13). См. `../decisions/05_and_my_respec.md` и `../SYSTEM_SUICIDE.md` §8.

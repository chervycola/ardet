...
<text x="1020" y="134" text-anchor="end" font-family="'Courier New',monospace" font-size="20" letter-spacing="3" fill="#E30613">ДЕВАЙС № 27</text>
...
fs.writeFileSync(`${OUT}/ravzar-01.svg`, svg);
console.log('ravzar-01.svg written');

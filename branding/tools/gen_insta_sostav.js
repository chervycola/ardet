...
${wrap('25 участников экспо, 11 артистов на четырёх сценах, 13 лекторов, пять мастер-классов и шесть инсталляций. Полный список — в карточках. Листайте.', 41)
...
${headText('25 УЧАСТНИКОВ', 492, '#E30613')}
${shLine(60,1020,576,8)}
${listBlock(60, 656, EXPO.slice(0,13), 25, 42)}
${listBlock(560, 656, EXPO.slice(13), 25, 42)}`);
...
${secHead(60,370,'ЭКСПО · 25')}
${listBlock(60, 412, EXPO.slice(0,13), 24, 36)}
${listBlock(60, 412+13*36+18, EXPO.slice(13), 24, 36)}

const fs = require('fs');
const OUT = __dirname + '/../renders/final';
...
<text x="1020" y="66" text-anchor="end" font-family="'Courier New',monospace" font-size="19" letter-spacing="2" fill="#000">СЕГОДНЯ</text>
<line x1="60" y1="96" x2="1020" y2="96" stroke="#000" stroke-width="2"/>
<text x="1020" y="134" text-anchor="end" font-family="'Courier New',monospace" font-size="20" letter-spacing="3" fill="#E30613">19.09 · 12:00</text>
${inner}
...
const c1 = shell('01','01', `${towers}
${kick('ДВЕРИ ОТКРЫВАЮТСЯ В 13:00')}
${headText('ЧЕРЕЗ ЧАС', 350, '#000')}
${headText('НАЧИНАЕМ', 492, '#E30613')}
${shLine(60,1020,576,8)}
${body('В 13:00 открываем двери и экспо: на демо-сцене — Артемий Анрилов и xander.vasiliev с аудиовизуальным выступлением. Дальше без пауз до 20:00 — 29 участников экспо, лекторий в двух залах, мастерские, детская, Андер-Галерея, Вестибюль и улица.', 664)}
${plate('ЖДЁМ ВАС В МИЭТЕ', 1067)}`);

fs.writeFileSync(`${OUT}/hour-01.svg`, c1);
console.log('hour-01.svg written');

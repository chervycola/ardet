...
const hiddenInscriptions = {
  ...
  ruins: ['квартира 42', 'термометр 42°C', 'аннушка уже разлила', 'примус починил', 'вобла не горит'],
  ...
  theater: ['ХРОМАЯ ЛОШАДЬ', '5.12.09 — 156 имён', 'выход заперт снаружи', 'бенгальские огни в помещении', 'пенопласт горит чёрным', 'занавес не упал — он сгорел'],
  posterwall: ['все билеты проданы', '5 свечей. 5 дат.', 'версия 47', 'выход заперт снаружи', 'повод будет'],
};

...
(function(){
  ...
  const ui=(function(){
    let btn=null,panel=null,open=false;
    function build(){
      if(btn||!document.body) return;
      const css=document.createElement('style');
      css.textContent=`
      #ardetRadioBtn{position:fixed;right:16px;bottom:16px;z-index:30;
        background:linear-gradient(172deg,#EEE3CB,#E0D2B4);color:#3A3026;border:none;
        transform:rotate(1.4deg);padding:7px 13px 8px;cursor:pointer;
      ...
      #ardetRadioPanel{position:fixed;right:16px;bottom:56px;z-index:30;min-width:210px;
        background:linear-gradient(172deg,#EEE3CB,#E0D2B4);color:#3A3026;
        transform:rotate(-0.8deg);padding:10px 12px;box-shadow:0 8px 26px rgba(0,0,0,.6);display:none}
